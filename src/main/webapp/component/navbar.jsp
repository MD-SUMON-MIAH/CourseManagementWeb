		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj }">
					<li class="nav-item text-light bg-dark"><a class="nav-link active"
						aria-current="page" href="admin_login.jsp">
						<i class="fas fa-sign-in-alt"></i> ADMIN</a></li>

					<li class="nav-item text-dark"><a class="nav-link active"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="registared_courses.jsp?dId=${userObj.id}">VIEW COURSES</a></li>
